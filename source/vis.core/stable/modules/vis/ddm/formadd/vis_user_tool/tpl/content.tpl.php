...
<td class="ddm_datacol ddm_datacol_title"><?php echo $this->getFormAddElementOption($ddm_group, $element, 'title')?><?php if($this->getFormAddElementOption($ddm_group, $element, 'required')===true):?><?php echo $this->getMessage($ddm_group, 'form_title_required_icon')?><?php endif?><?php echo $this->getMessage($ddm_group, 'form_title_closer')?></td>
