...
<br/>
<?php endif?>
<?php echo osW_Form::getInstance()->drawCheckBoxField($element.'_'.$group_id, '1', ((isset($ar_groups[$group_id])&&($ar_groups[$group_id]=1)) ? $ar_groups[$group_id] : 0), array())?> <?php echo h()->_outputString($group_name_intern)?>
<?php endforeach;?>
