...
osW_DDM3::getInstance()->addDataElement($ddm_group, 'select_id', array(
	'module'=>'index',
	'title'=>'ID',
	'name'=>'select_id',
));
...
switch ($ddm_navigation_id) {
	case 1:
		osW_DDM3::getInstance()->addDataElement($ddm_group, 'select_example', array(
			'module'=>'select',
			'title'=>'Select',
			'name'=>'select_example',
		));
...
osW_DDM3::getInstance()->addDataElement($ddm_group, 'select_check', array(
	'module'=>'text',
	'title'=>'Required',
	'name'=>'select_check',
	'options'=>array(
