...
osW_DDM3::getInstance()->addDataElement($ddm_group, 'textarea_id', array(
	'module'=>'index',
	'title'=>'ID',
	'name'=>'textarea_id',
));
...
switch ($ddm_navigation_id) {
	...
	case 2:
		osW_DDM3::getInstance()->addDataElement($ddm_group, 'text_example', array(
			...
			'name'=>'textarea_example',
			'options'=>array(
				'notice'=>'String zwischen 20 und 1200 Zeichen',
			),
			'validation'=>array(
				'module'=>'string',
				'length_min'=>20,
	...
	case 99:
		...
		break;
	default:
		osW_DDM3::getInstance()->addDataElement($ddm_group, 'textarea_example', array(
			'module'=>'textarea',
			'title'=>'Textarea',
			'name'=>'textarea_example',
			'options'=>array(
...
osW_DDM3::getInstance()->addDataElement($ddm_group, 'textarea_check', array(
	'module'=>'text',
	'title'=>'Required',
	'name'=>'textarea_check',
	'options'=>array(
