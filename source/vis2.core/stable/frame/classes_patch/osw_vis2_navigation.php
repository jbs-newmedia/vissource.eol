...
if (($av_tbl<=2)&&($ab_tbl<2)) {
	$QwriteData=osW_Database::getInstance()->query('ALTER TABLE :table: ADD navigation_intern_sortorder INT( 11 ) NOT NULL AFTER navigation_sortorder ,
		ADD INDEX (navigation_intern_sortorder)');
	$QwriteData->bindTable(':table:', $table);
	$QwriteData->execute();
