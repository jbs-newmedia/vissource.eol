...
if ((!isset($ar_tool_user[osW_VIS2::getInstance()->getToolID()]))||($ar_tool_user[osW_VIS2::getInstance()->getToolID()]!==$ar_tool_user_do[osW_VIS2::getInstance()->getToolID()])) {
	if ((isset($ar_tool_user_do[osW_VIS2::getInstance()->getToolID()]))&&($ar_tool_user_do[osW_VIS2::getInstance()->getToolID()]==1)) {
		...
		if ($this->getGroupOption($ddm_group, 'enable_log')===true) {
			if ($this->getFinishElementOption($ddm_group, $element_storage, 'createupdatestatus_prefix')!='') {
				if (!in_array($element_current, [$this->getFinishElementOption($ddm_group, $element_storage, 'createupdatestatus_prefix').'update_user_id', $this->getFinishElementOption($ddm_group, $element_storage, 'createupdatestatus_prefix').'update_time'])) {
					osW_DDM4_Log::getInstance()->addValue($group, $element_current, '✘ '.osW_VIS2::getInstance()->getToolName(), '✔ '.osW_VIS2::getInstance()->getToolName(), $this->getEditElementStorage($ddm_group, $this->getFinishElementOption($ddm_group, $element_storage, 'createupdatestatus_prefix').'update_user_id'), $this->getEditElementStorage($ddm_group, $this->getFinishElementOption($ddm_group, $element_storage, 'createupdatestatus_prefix').'update_time'), $this->getDoEditElementStorage($ddm_group, $this->getFinishElementOption($ddm_group, $element_storage, 'createupdatestatus_prefix').'update_user_id'), $this->getDoEditElementStorage($ddm_group, $this->getFinishElementOption($ddm_group, $element_storage, 'createupdatestatus_prefix').'update_time'));
				}
			} else {
				osW_DDM4_Log::getInstance()->addValue($group, $element_current, '✘ '.osW_VIS2::getInstance()->getToolName(), '✔ '.osW_VIS2::getInstance()->getToolName());
			}
	...
	} elseif ((isset($ar_tool_user[osW_VIS2::getInstance()->getToolID()]))&&($ar_tool_user_do[osW_VIS2::getInstance()->getToolID()]==0)) {
