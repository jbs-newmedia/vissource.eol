...
$QsaveData=osW_Database::getInstance()->query('UPDATE :table_vis2_user: SET user_password=:user_password:, user_update_time=:user_update_time:, user_update_user_id=:user_update_user_id: WHERE user_id=:user_id:');
$QsaveData->bindTable(':table_vis2_user:', 'vis2_user');
$QsaveData->bindCrypt(':user_password:', $this->getDoSendElementStorage($ddm_group, 'user_password'));
$QsaveData->bindInt(':user_id:', osW_VIS2_User::getInstance()->getId());
