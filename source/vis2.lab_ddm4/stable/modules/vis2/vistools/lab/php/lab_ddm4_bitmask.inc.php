...
$ddm_group='vis2_lab_ddm4_bitmask';

$var='vis2_'.osW_VIS2::getInstance()->getTool().'_'.osW_VIS2_Navigation::getInstance()->getPage().'_ddm4_bitmask';
...
switch ($ddm_navigation_id) {
	case 1:
		...
		osW_DDM4::getInstance()->addDataElement($ddm_group, 'bitmask_example', array(
			'module'=>'bitmask',
			'title'=>'BitMask',
...
osW_DDM4::getInstance()->addDataElement($ddm_group, 'bitmask_check', array(
	'module'=>'text',
	'title'=>'Required',
	'name'=>'bitmask_check',
	'options'=>array(
