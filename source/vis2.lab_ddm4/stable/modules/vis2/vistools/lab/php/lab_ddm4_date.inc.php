...
$ddm_group='vis2_lab_ddm4_date';

$var='vis2_'.osW_VIS2::getInstance()->getTool().'_'.osW_VIS2_Navigation::getInstance()->getPage().'_ddm4_date';
...
switch ($ddm_navigation_id) {
	case 1:
		osW_DDM4::getInstance()->addDataElement($ddm_group, 'date_example', array(
			'module'=>'date',
			'title'=>'Datum',
			'name'=>'date_example',
			'options'=>array(
				'notice'=>'Default, mit Monat als Name.',
				'month_asname'=>true,
			),
		));
		break;
...
osW_DDM4::getInstance()->addDataElement($ddm_group, 'date_check', array(
	'module'=>'text',
	'title'=>'Required',
	'name'=>'date_check',
	'options'=>array(
