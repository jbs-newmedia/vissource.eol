...
switch ($ddm_navigation_id) {
	...
	case 99:
		...
		break;
	default:
		osW_DDM4::getInstance()->addDataElement($ddm_group, 'textarea_example', array(
			'module'=>'textarea',
			'title'=>'Textarea',
			'name'=>'textarea_example',
			'options'=>array(
...
osW_DDM4::getInstance()->addDataElement($ddm_group, 'textarea_check', array(
	'module'=>'text',
	'title'=>'Required',
	'name'=>'textarea_check',
	'options'=>array(
