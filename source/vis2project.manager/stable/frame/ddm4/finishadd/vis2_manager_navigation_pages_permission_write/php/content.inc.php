...
$ar_navigation_permission=$this->getAddElementStorage($ddm_group, substr($element, 0, -6));
$ar_navigation_permission_do=$this->getDoAddElementStorage($ddm_group, substr($element, 0, -6));
