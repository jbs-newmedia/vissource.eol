...
$ddm_group='vis2_manager_navigation';
...
$ar_tools=osW_VIS2_Manager::getInstance()->getTools();
$tool_details=array();
if ((osW_Session::getInstance()->value($var)!='')&&(isset($ar_tools[osW_Session::getInstance()->value($var)]))) {
	...
	$tool_details=osW_VIS2::getInstance()->getToolDetails($_POST['tool_id']);
...
if ($ddm_navigation_id==0) {
	...
	osW_DDM4::getInstance()->addSendElement($ddm_group, 'tool_id', array(
		'module'=>'select',
		'title'=>'Tool',
		'name'=>'tool_id',
		'options'=>array(
			'data'=>osW_VIS2_Manager::getInstance()->getTools(),
		),
		'validation'=>array(
			'module'=>'integer',
			'length_min'=>1,
	...
	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_navigation_toolid', array(
		'module'=>'vis2_manager_navigation_toolid',
	));
...
if (in_array($ddm_navigation_id, array(1))) {
	...
	osW_DDM4::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'tool_id', 'operator'=>'=', 'value'=>$_POST['tool_id'])))), 'database');
	...
	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_navigation_permission_delete', array(
		'module'=>'vis2_manager_navigation_permission_delete',
	));
...
if (in_array($ddm_navigation_id, array(2))) {
	...
	osW_DDM4::getInstance()->addDataElement($ddm_group, 'vis2_manager_navigation_pages_permission', array(
		'module'=>'vis2_manager_navigation_pages_permission',
		'title'=>'Rechte',
	));
	...
	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_navigation_pages_permission_write', array(
		'module'=>'vis2_manager_navigation_pages_permission_write',
	));

	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_navigation_pages_permission_delete', array(
		'module'=>'vis2_manager_navigation_pages_permission_delete',
	));
...
if (in_array($ddm_navigation_id, array(3))) {
	...
	$ar_level=array();
	$ar_data[0]='-';
	foreach (osW_VIS2_Navigation::getInstance()->getNavigation(0, osW_DDM4::getInstance()->getGroupOption($ddm_group, 'navigation_level'), $_POST['tool_id']) as $navigation_element_1) {
	...
	osW_DDM4::getInstance()->addDataElement($ddm_group, 'page_id', array(
		...
		'options'=>array(
			'search'=>true,
			'data'=>osW_VIS2_Navigation::getInstance()->getPages($_POST['tool_id']),
		),
		'validation'=>array(
			'module'=>'integer',
			'length_min'=>0,
	...
	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_navigation_delete', array(
		'module'=>'vis2_manager_navigation_delete',
	));

	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_navigation_sort', array(
		'module'=>'vis2_manager_navigation_sort',
	));
...
if (in_array($ddm_navigation_id, array(4))) {
	...
	osW_DDM4::getInstance()->addDataElement($ddm_group, 'vis2_manager_group_permission', array(
		'module'=>'vis2_manager_group_permission',
		'title'=>'Rechte',
	));
	...
	osW_DDM4::getInstance()->addDataElement($ddm_group, 'vis2_manager_group_user', array(
		'module'=>'vis2_manager_group_user',
		'title'=>'Benutzer',
	));
	...
	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_group_permission_write', array(
		'module'=>'vis2_manager_group_permission_write',
	));

	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_group_user_write', array(
		'module'=>'vis2_manager_group_user_write',
	));

	osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_group_delete', array(
		'module'=>'vis2_manager_group_delete',
	));
