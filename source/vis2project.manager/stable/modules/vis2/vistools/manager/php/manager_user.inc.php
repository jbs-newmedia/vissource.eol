...
osW_DDM4::getInstance()->addDataElement($ddm_group, 'vis2_manager_user_tool', array(
	'module'=>'vis2_manager_user_tool',
	'title'=>'Tools',
));
...
osW_DDM4::getInstance()->addDataElement($ddm_group, 'vis2_manager_user_group', array(
	'module'=>'vis2_manager_user_group',
	'title'=>'Gruppen',
));
...
osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_user_tool_write', array(
	'module'=>'vis2_manager_user_tool_write',
));

osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_user_group_write', array(
	'module'=>'vis2_manager_user_group_write',
));

osW_DDM4::getInstance()->addFinishElement($ddm_group, 'vis2_manager_user_delete', array(
	'module'=>'vis2_manager_user_delete',
));
