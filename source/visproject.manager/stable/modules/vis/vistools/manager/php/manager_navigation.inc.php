...
$ddm_group='vis_manager_navigation';
...
$ar_tools=osW_VIS_Manager::getInstance()->getTools();
$tool_details=array();
if ((osW_Session::getInstance()->value($var)!='')&&(isset($ar_tools[osW_Session::getInstance()->value($var)]))) {
	if (!isset($_POST['tool_id'])) {
		$_POST['tool_id']=osW_Session::getInstance()->value($var);
	}
	$tool_details=osW_VIS::getInstance()->getToolDetails($_POST['tool_id']);

	if ($tool_details!=array()) {
...
if ($ddm_navigation_id==0) {
	...
	osW_DDM3::getInstance()->addSendElement($ddm_group, 'navigation', array(
		'module'=>'navigation',
		'options'=>array(
	...
	osW_DDM3::getInstance()->addSendElement($ddm_group, 'tool_id', array(
		'module'=>'select',
		'title'=>'Tool',
		'name'=>'tool_id',
		'options'=>array(
			'data'=>osW_VIS_Manager::getInstance()->getTools(),
		),
		'validation'=>array(
			'module'=>'integer',
			'length_min'=>1,
	...
	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_navigation_toolid', array(
		'module'=>'vis_manager_navigation_toolid',
	));
...
if (in_array($ddm_navigation_id, array(1))) {
	...
	osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'tool_id', 'operator'=>'=', 'value'=>$_POST['tool_id'])))), 'database');
	...
	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_navigation_permission_delete', array(
		'module'=>'vis_manager_navigation_permission_delete',
	));
...
if (in_array($ddm_navigation_id, array(2))) {
	...
	osW_DDM3::getInstance()->addDataElement($ddm_group, 'vis_manager_navigation_pages_permission', array(
		'module'=>'vis_manager_navigation_pages_permission',
		'title'=>'Rechte',
	));
	...
	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_navigation_pages_permission_write', array(
		'module'=>'vis_manager_navigation_pages_permission_write',
	));

	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_navigation_pages_permission_delete', array(
		'module'=>'vis_manager_navigation_pages_permission_delete',
	));
...
if (in_array($ddm_navigation_id, array(3))) {
	...
	$ar_data=array();
	if (count(osW_VIS_Navigation::getInstance()->getNavigation(0, osW_DDM3::getInstance()->getGroupOption($ddm_group, 'navigation_level'), $_POST['tool_id']))>0) {
		foreach (osW_VIS_Navigation::getInstance()->getNavigation(0, osW_DDM3::getInstance()->getGroupOption($ddm_group, 'navigation_level'), $_POST['tool_id']) as $navigation_element_1) {
	...
	osW_DDM3::getInstance()->addDataElement($ddm_group, 'page_id', array(
		...
		'name'=>'page_id',
		'options'=>array(
			'data'=>osW_VIS_Navigation::getInstance()->getPages($_POST['tool_id']),
		),
		'validation'=>array(
			'module'=>'integer',
			'length_min'=>0,
	...
	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_navigation_delete', array(
		'module'=>'vis_manager_navigation_delete',
	));
...
if (in_array($ddm_navigation_id, array(4))) {
	...
	osW_DDM3::getInstance()->addDataElement($ddm_group, 'vis_manager_group_permission', array(
		'module'=>'vis_manager_group_permission',
		'title'=>'Rechte',
	));

	osW_DDM3::getInstance()->addDataElement($ddm_group, 'vis_manager_group_user', array(
		'module'=>'vis_manager_group_user',
		'title'=>'Benutzer',
	));
	...
	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_group_permission_write', array(
		'module'=>'vis_manager_group_permission_write',
	));

	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_group_user_write', array(
		'module'=>'vis_manager_group_user_write',
	));

	osW_DDM3::getInstance()->addFinishElement($ddm_group, 'vis_manager_group_delete', array(
		'module'=>'vis_manager_group_delete',
	));
