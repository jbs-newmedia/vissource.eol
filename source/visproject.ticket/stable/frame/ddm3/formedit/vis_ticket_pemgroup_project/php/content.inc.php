...
$ar_tool_user=array();
$QloadData=osW_Database::getInstance()->query('SELECT * FROM :table_vis_ticket_pemgroup_project: WHERE group_id=:group_id:');
$QloadData->bindTable(':table_vis_ticket_pemgroup_project:', 'vis_ticket_pemgroup_project');
