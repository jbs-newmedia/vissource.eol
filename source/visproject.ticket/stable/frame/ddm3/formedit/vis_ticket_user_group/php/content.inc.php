...
$ar_tool_user=array();
$QloadData=osW_Database::getInstance()->query('SELECT * FROM :table_vis_ticket_user_group: WHERE user_id=:user_id:');
$QloadData->bindTable(':table_vis_ticket_user_group:', 'vis_ticket_user_group');
...
if (osW_Settings::getInstance()->getAction()=='doedit') {
	$ar_user_tool=array();
	foreach(osW_VIS_Ticket::getInstance()->getGroups2Users() as $tool_id => $tool_name) {
