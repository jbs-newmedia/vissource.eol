...
$ar_tool_user=array();
$QloadData=osW_Database::getInstance()->query('SELECT * FROM :table_vis_ticket_user_project: WHERE user_id=:user_id:');
$QloadData->bindTable(':table_vis_ticket_user_project:', 'vis_ticket_user_project');
