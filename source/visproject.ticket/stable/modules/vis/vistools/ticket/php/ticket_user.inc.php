...
if (($ticket_data!=array())&&($view=='ticket')) {
	...
	$getcount=osW_VIS_Ticket::getInstance()->getCounter('user_id='.osW_VIS_User::getInstance()->getId().' AND project_id IN ('.implode(',', $project_ids).')');
	...
	if (in_array($ddm_navigation_id, array(1))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')'), array('key'=>'ticket_create_time ', 'operator'=>'>', 'value'=>(time()-(60*60*24*7)))))), 'database');
	...
	if (in_array($ddm_navigation_id, array(2))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')'), array('key'=>'ticket_update_time ', 'operator'=>'>', 'value'=>(time()-(60*60*24*7)))))), 'database');
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'order', array('ticket_number'=>'desc'), 'database');
	}

	if (in_array($ddm_navigation_id, array(3))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')'), array('key'=>'status_id ', 'operator'=>'IN', 'value'=>'('.implode(',', (osW_VIS_Ticket::getInstance()->getStatusDataOpen(false, 'status_internal_id', 'status_internal_id'))).')')))), 'database');
	}

	if (in_array($ddm_navigation_id, array(6))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')'), array('key'=>'status_id ', 'operator'=>'IN', 'value'=>'('.implode(',', (osW_VIS_Ticket::getInstance()->getStatusDataWaiting(false, 'status_internal_id', 'status_internal_id'))).')')))), 'database');
	}

	if (in_array($ddm_navigation_id, array(4))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')'), array('key'=>'status_id ', 'operator'=>'IN', 'value'=>'('.implode(',', (osW_VIS_Ticket::getInstance()->getStatusDataAssigned(false, 'status_internal_id', 'status_internal_id'))).')')))), 'database');
	}

	if (in_array($ddm_navigation_id, array(7))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')'), array('key'=>'status_id ', 'operator'=>'IN', 'value'=>'('.implode(',', (osW_VIS_Ticket::getInstance()->getStatusDataInWork(false, 'status_internal_id', 'status_internal_id'))).')')))), 'database');
	}

	if (in_array($ddm_navigation_id, array(5))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')'), array('key'=>'status_id ', 'operator'=>'IN', 'value'=>'('.implode(',', (osW_VIS_Ticket::getInstance()->getStatusDataClosed(false, 'status_internal_id', 'status_internal_id'))).')')))), 'database');
	}

	if (in_array($ddm_navigation_id, array(99))) {
		osW_DDM3::getInstance()->setGroupOption($ddm_group, 'filter', array(array('and'=>array(array('key'=>'user_id ', 'operator'=>'=', 'value'=>osW_VIS_User::getInstance()->getId()), array('key'=>'project_id ', 'operator'=>'IN', 'value'=>'('.implode(',', $project_ids).')')))), 'database');
	}
