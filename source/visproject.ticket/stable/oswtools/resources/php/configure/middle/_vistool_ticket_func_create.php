...
$this->data['settings']['data']=array(
	'page_title'=>'VISTool-Ticket Settings',
);
...
if (($position=='run')&&(isset($_POST['next']))&&($_POST['next']=='next')) {
	...
	if ((isset($this->data['values_json']['vis_tool_ticket']))&&($this->data['values_json']['vis_tool_ticket']==1)) {
	...
	$_vis_script['tool']=array(
		'tool_name'=>'Ticket',
		'tool_name_intern'=>'ticket',
		'tool_description'=>'Ticket-Tool',
		'tool_status'=>1,
		'tool_hide_logon'=>0,
	...
	$_vis_script['group'][1]=array(
		'group_name'=>'Ticket-Admin',
		'group_name_intern'=>'ticket_admin',
		'group_description'=>'Ticket-Admin',
		'group_status'=>1,
	);
	...
	$_vis_script['navigation'][]=array(
		'navigation_parent_id'=>0,
		'navigation_title'=>'Ticket',
		'navigation_sortorder'=>20,
		'navigation_ispublic'=>1,
		'page'=>array(
			'page_name'=>'Header Ticket',
			'page_name_intern'=>'header_ticket',
			'page_description'=>'Header Ticket',
			'page_ispublic'=>1,
			'permission'=>array('link'),
		),
		'permission'=>array(
	...
	$_vis_script['navigation'][]=array(
		'navigation_parent_id'=>'header_ticket',
		'navigation_title'=>'Alle',
		'navigation_sortorder'=>10,
		'navigation_ispublic'=>1,
		'page'=>array(
			'page_name'=>'Ticket Alle',
			'page_name_intern'=>'ticket_all',
			'page_description'=>'Ticket Alle',
			'page_ispublic'=>1,
			'permission'=>array('link','view'),
		),
		'permission'=>array(
	...
	$_vis_script['navigation'][]=array(
		'navigation_parent_id'=>'header_ticket',
		'navigation_title'=>'Meine',
		'navigation_sortorder'=>20,
		'navigation_ispublic'=>1,
		'page'=>array(
			'page_name'=>'Ticket Meine',
			'page_name_intern'=>'ticket_user',
			'page_description'=>'Ticket Meine',
			'page_ispublic'=>1,
			'permission'=>array('link','view'),
		),
		'permission'=>array(
	...
	$_vis_script['navigation'][]=array(
		'navigation_parent_id'=>'header_ticket',
		'navigation_title'=>'Gruppe',
		'navigation_sortorder'=>30,
		'navigation_ispublic'=>1,
		'page'=>array(
			'page_name'=>'Ticket Gruppe',
			'page_name_intern'=>'ticket_group',
			'page_description'=>'Ticket Gruppe',
			'page_ispublic'=>1,
			'permission'=>array('link','view'),
		),
		'permission'=>array(
	...
	$_vis_script['navigation'][]=array(
		...
		'navigation_sortorder'=>100,
		'navigation_ispublic'=>1,
		'page'=>array(
			'page_name'=>'Ticket Einstellungen',
			'page_name_intern'=>'ticket_configure',
			'page_description'=>'Ticket Einstellungen',
			'page_ispublic'=>1,
			'permission'=>array('link','view'),
		),
		'permission'=>array(
	...
	$_vis_script['navigation'][]=array(
		'navigation_parent_id'=>'header_ticket',
		'navigation_title'=>'Admin',
		'navigation_sortorder'=>150,
		'navigation_ispublic'=>1,
		'page'=>array(
			'page_name'=>'Ticket Admin',
			'page_name_intern'=>'ticket_admin',
			'page_description'=>'Ticket Admin',
			'page_ispublic'=>1,
			'permission'=>array('link','view'),
		),
		'permission'=>array(
	...
	$this->data['messages'][]='VISTool-Ticket configured successfully';
}
